"""
Django settings for TreasureHuntGame project.
...
SECRET_KEY = '0-$!3^a1ged+=svh7vlav(q&hzy3&spwrbv@g-li1=&*xtf79^'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # 一种防止网络攻击方法
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'TreasureHuntGame.urls'
...
WSGI_APPLICATION = 'TreasureHuntGame.wsgi.application'
